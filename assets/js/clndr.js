...
(function (factory) {
  ...
  var clndrTemplate =
    "<div class='clndr-controls position-relative'>" +
        "<div class='clndr-control-button position-absolute bottom-0 start-0'>" +
            "<span class='clndr-previous-button'>Anterior</span>" +
        '</div>' +
        "<div class='month position-absolute top-50 start-50 translate-middle'><%= month %> <%= year %></div>" +
        "<div class='clndr-control-button position-absolute bottom-0 end-0'>" +
            "<span class='clndr-next-button' style='float:right'>Siguiente</span>" +
        '</div>' +
    '</div>' +
    "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
        ...
        '<% for(var i = 0; i < numberOfRows; i++){ %>' +
            ...
            '<% for(var j = 0; j < 7; j++){ %>' +
            '<% var d = j + i * 7; %>' +
                "<td class='<%= days[d].classes %> position-relative'>" +
                    "<div class='day-contents position-absolute top-50 start-50 translate-middle'><%= days[d].day %></div>" +
                '</td>' +
            '<% } %>' +
            '</tr>' +
        '<% } %>' +
